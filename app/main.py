...
from app.routes import auth, driver_location_route, signal_route, matching_route, role_change, admin_route
import asyncio
...
app.include_router(admin_route.router, prefix="/admin")