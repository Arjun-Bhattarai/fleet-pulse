...
Revision ID: eb7cdcd07200
Revises: 281e359add94
Create Date: 2026-05-08 16:24:39.073933
...
revision: str = 'eb7cdcd07200'
down_revision: Union[str, Sequence[str], None] = '281e359add94'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('signals_user_id_fkey')),
